...
mechanism. In UniCore, **DID Web** and **DID IOTA** support Domain Linkage, whereas **DID JWK** and **DID Key** do not.
:::
...
if the `UNICORE__URL` environment variable contains a path segment. For example, Domain Linkage will **not** work with:
