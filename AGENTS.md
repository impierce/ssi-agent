...
- `agent_api_http/openapi.yaml` — generated by `cargo test generate_openapi_spec`, which writes this
  exact path. Don't hand-edit it; change the `#[utoipa::path(...)]` annotations and regenerate.
