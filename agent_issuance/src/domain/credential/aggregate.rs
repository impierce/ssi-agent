use super::command::CredentialCommand;
use super::entity::Data;
use super::error::CredentialError::{self};
...
pub mod credential_tests {
    ...
    use super::super::aggregate::Credential;
    use super::super::event::CredentialEvent;
    use crate::domain::offer::aggregate::test_utils::holder;
