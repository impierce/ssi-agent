...
use super::command::OfferCommand;
use super::error::OfferError::{self, *};
        ...
        match command {
            ...
            VerifyCredentialRequest {
                ...
                let credential_issuer = CredentialIssuer {
                    ...
                    // FIXME
                    authorization_server_metadata: AuthorizationServerMetadata::default(),
                };
...
pub mod tests {
    ...
    use crate::domain::{
        credential::aggregate::test_utils::{notification_id, OPENBADGE_VERIFIABLE_CREDENTIAL_JWT},
        offer,
...
pub mod test_utils {
    pub use super::*;
    use crate::{
        domain::credential::aggregate::test_utils::{notification_id, OPENBADGE_VERIFIABLE_CREDENTIAL_JWT},
        domain::server_config::aggregate::test_utils::*,
    };
