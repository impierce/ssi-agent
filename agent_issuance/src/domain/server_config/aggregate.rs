...
use super::command::ServerConfigCommand;
use super::error::ServerConfigError;
use super::event::ServerConfigEvent;
...
pub mod server_config_tests {
    use super::super::aggregate::ServerConfig;
    use super::super::event::ServerConfigEvent;
...
pub mod test_utils {
    use super::*;
    use crate::domain::credential::aggregate::test_utils::W3C_VC_CREDENTIAL_CONFIGURATION;
