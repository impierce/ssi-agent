use crate::v0::library::catalog::{
    __path_add_templates, __path_create_catalog, __path_delete_catalog, __path_remove_template, __path_update_display,
...
#[derive(OpenApi)]
#[openapi(
    paths(create_catalog, delete_catalog, add_templates, remove_template, update_display, update_visibility, get_all_catalogs, get_catalog),
    tags(
