...
async fn runtime_services_preserve_identity_and_survive_restart() {
    ...
    fixture.post("reissue-domain-linkage", None, 404).await;
    ...
    fixture.post("reissue-domain-linkage", None, 204).await;
    assert_ne!(fixture.linkage().await, linkage);
    assert_eq!(fixture.did().await, document);
    fixture.validate().await;
    ...
    for operation in [
        ...
        "identity.services.domain_linkage.reissue",
...
#[tokio::test]
#[serial_test::serial]
async fn drift_replaces_identity_automatically_and_retains_keys() {
    let fixture = Fixture::new().await;
...
async fn verify_domain_linkage_reports_failure_before_creation() {
    let fixture = Fixture::new().await;
    let (status, body) = fixture.request("POST", "/unicore/v0/verify-domain-linkage", None).await;
    assert_eq!(status, 200);
...
async fn unauthorized_service_commands_do_not_mutate_identity() {
    ...
    let original = fixture.did().await;
    for command in [
        "create-domain-linkage",
        "reissue-domain-linkage",
        "remove-domain-linkage",
    ...
    fixture.post("reissue-domain-linkage", None, 403).await;
    fixture.post("remove-domain-linkage", None, 403).await;
    fixture.post("verify-domain-linkage", None, 403).await;
    fixture
        .post(
            "create-linked-verifiable-presentation",
            Some(json!({"presentationIds": ["presentation-1"]})),
