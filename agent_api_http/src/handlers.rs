...
// Outer Option indicates whether the Extension is present (authorization enabled).
// Inner Option indicates whether an Actor is present.
pub fn request_actor(actor: &Option<Extension<Option<Actor>>>) -> Option<Option<Actor>> {
