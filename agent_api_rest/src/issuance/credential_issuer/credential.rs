                        ...
                        OfferEvent::CredentialRequestVerified { offer_id, subject_id } => {
                            ...
                            futures::executor::block_on(async {
                                ...
                                let credentials_endpoint_request = if is_self_signed {
                                    CredentialsRequest {
                                        offer_id: offer_id.clone(),
                                        credential: json!("eyJ0eXAiOiJKV1QiLCJhbGciOiJFZERTQSIsImtpZCI6ImRpZDprZXk6ejZNa2dFODROQ01wTWVBeDlqSzljZjVXNEc4Z2NaOXh1d0p2RzFlN3dOazhLQ2d0I3o2TWtnRTg0TkNNcE1lQXg5aks5Y2Y1VzRHOGdjWjl4dXdKdkcxZTd3Tms4S0NndCJ9..MzHsluxKNsnA01df0kUyXVBIzkBJajKhHbuG-_vNGz0QAPQ16jZ4IwAtEwt6XfbV9luFalRL3qtsmDvaNBf7CA"),
                                        is_signed: true,
                                    }
                                } else {
